...
def comprimir():
    ...
    for i in range (1,31):
        ...
        image = image.save("C:/Users/Nico/Desktop/TareaComunicacionesDigitales/JP2/compresion/" + str(i) + '.jp2', 'JPEG2000', quality = 10)
...
def startEntropy():
    ...
    for i in range(1, 31):
        ...
        tamanoComprimido = os.path.getsize("C:/Users/Nico/Desktop/TareaComunicacionesDigitales/JP2/compresion/" + str(i) + '.jp2')
        ...
        imageComprimida = Image.open( "C:/Users/Nico/Desktop/TareaComunicacionesDigitales/JP2/compresion/" + str(i) + '.jp2')

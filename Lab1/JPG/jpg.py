...
def comprimir():
    ...
    for i in range (1,31):
        ...
        image = image.save("C:/Users/Nico/Desktop/TareaComunicacionesDigitales/JPG/compresion/" + str(i) + '.jpg', 'JPEG', quality = 10)
...
def startEntropy():
    ...
    for i in range(1, 31):
        ...
        tamanoComprimido = os.path.getsize("C:/Users/Nico/Desktop/TareaComunicacionesDigitales/JPG/compresion/" + str(i) + '.jpg')
        imageOriginal = Image.open( "C:/Users/Nico/Desktop/TareaComunicacionesDigitales/muestrasIMG/" + str(i) + ".png")
        imageComprimida = Image.open( "C:/Users/Nico/Desktop/TareaComunicacionesDigitales/JPG/compresion/" + str(i) + '.jpg')
